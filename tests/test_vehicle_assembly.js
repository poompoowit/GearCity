...
assert(
  ...
  bSports1904.minKg === 140 && bSports1904.targetKg === 190 && bSports1904.maxKg === 245,
  '1904 Sports Engine Weight Benchmark accurately targets 190 kg (140-245 kg range)',
...
assert(
  ...
  bLimo1904.minKg === 240 && bLimo1904.targetKg === 310 && bLimo1904.maxKg === 390,
  '1904 Limousine Engine Weight Benchmark accurately targets 310 kg (240-390 kg range)',
...
assert(
  ...
  bMicro1904.minKg === 45 && bMicro1904.targetKg === 65 && bMicro1904.maxKg === 90,
  '1904 Microcar Engine Weight Benchmark bounds engine to lightweight 65 kg target (45-90 kg)',
...
assert(
  ...
  bSedan1960.targetKg === 160 && bSedan1960.maxKg === 200,
  '1960 Sedan Engine Weight Benchmark matches thin-wall I4/V8 era target (160 kg)',
...
assert(
  ...
  bCompact2010.targetKg === 95 && bCompact2010.maxKg === 120,
  '2010 Compact Car Engine Weight Benchmark reflects modern turbo-downsizing (95 kg target)',
...
assert(
  cSports1904 && cSports1904.maxWeight === 245 && cSports1904.eraBenchmark && cSports1904.eraBenchmark.targetKg === 190,
  'getEngineDesignConstraints dynamically provides era-scaled maxWeight for 1904 Sports (245 kg max, 190 kg target)',
